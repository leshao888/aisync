...
![Version](https://img.shields.io/badge/version-0.2.0a3-0A7AFF)
...
`v0.2.0a3` is an alpha iteration. Codex is the first stable profile; key, recipient, history, pull, conflict detection, richer `doctor`, and stricter `profile` validation are available for vault operations.
